...
<body>
  <div class="side-bar">
    ...
    <ul class="menu_txt">
      <li><img src="resource/img/bn_1_1_1.png" alt=""><a href="productList.ssg.php">영화</a></li>
      <li><img src="resource/img/bn_1_1_2.png" alt=""><a href="List3.ssg.php">예매</a></li>
      <li><img src="resource/img/bn_1_1_3.png" alt=""><a href="List2.ssg.php">극장</a></li>
      <li><img src="resource/img/bn_1_1_4.png" alt=""><a href="List4.ssg.php">이벤트</a></li>
    </ul>
